...
export default function Dashboard() {
  ...
  return (
    <section>
      {!session ? (
        <div >
          <h1 className="text-4xl font-bold  leading-loose ml-10">Welcome Readers!</h1>
          <div className="bg-gray-100 w-full">
          <h2 className="text-2xl semi-bold ml-10 mt-5">All Blogs</h2>
          <ul className="bg-red ml-10 w-[90%]">
            {allblogs.map((allBlog, index) => (
              ...
              >
                ...
                <p className="mt-3">
                  ...
                  <Link href={`/author/${allBlog.name}`}
                      className="ml-2 text-sm text-blue-500">{allBlog.name}
                    </Link>
                  </p>
                </div>
